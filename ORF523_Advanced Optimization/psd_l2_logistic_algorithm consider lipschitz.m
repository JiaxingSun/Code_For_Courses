...
plot(1:numcyc,loglossl2av-mini,1:numcyc,comp),legend('Empirical','Theoretical'),title('Comparison of convergence rate','FontSize',15),xlabel('number of iterates','FontSize',10);